	...
	<div class="logo_products">
		...
		<div class="w3ls_logo_products_left1">
				<ul class="phone_email">
					<li><i class="fa fa-phone" aria-hidden="true"></i>Hubungi Kami : +62 838 7055 7783</li>
				</ul>
			</div>
...
<!-- //navigation -->
	<!-- main-slider -->
		<ul id="demo1">
			<li>
				<img src="images/selamatdtg.png" width="950" height="500" />
			</li>
			<li>
				<img src="images/tokokita.png" width="950" height="500" />
			</li>
			
			<li>
				<img src="images/slmtbelanja.png" width="950" height="500" />
			</li>
		</ul>
	<!-- //main-slider -->
		...
		<div class="container">
			<div class="w3_footer_grids">
				<div class="col-md-4 w3_footer_grid">
					...
					<ul class="address">
					<li><i class="glyphicon glyphicon-map-marker" aria-hidden="true"></i>Salwa Adia Zahra</li>
						<li><i class="glyphicon glyphicon-envelope" aria-hidden="true"></i><a href="">zahrasalwaa380@gmail.com</a></li>
						<li><i class="glyphicon glyphicon-earphone" aria-hidden="true"></i>+62 838 7055 7783</li>
					</ul>
				</div>
